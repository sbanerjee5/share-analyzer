...
class KPICalculator:
                ...
                if hasattr(stock, 'news'):
                    ...
                    if news_data and len(news_data) > 0:
                        ...
                        for idx, article in enumerate(news_data[:5]):  # Limit to 5
                            ...
                            sentiment_result = StockAnalyzer.analyze_sentiment(sentiment_text)
    ...
    def determine_exchange_and_index(info: dict, ticker: str):
        """Determine exchange and UK stock index based on market cap and ticker"""
        ...
        # Determine UK index based on market cap (for .L tickers)
        index_name = None
